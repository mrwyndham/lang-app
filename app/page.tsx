...
export default function Chat() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      <div
        ref={parent}
        className="mx-4 pt-4 pb-24 flex flex-col text-white absolute z-20 overflow-y-scroll w-full max-h-full"
      >
        ...
        {startActionPending && (
          <div className="  bg-white rounded-xl mb-4 text-[#ff0000] p-6 w-[90%]">
            ...
            <div className="flex flex-row w-full gap-4 pt-4">
              <Button
                filled={true}
                onClick={() => setStartActionPending(false)}
              >
                Leave
              </Button>
              <Button onClick={() => setStartActionPending(false)}>Stay</Button>
            </div>
          </div>
        )}
        {startActionPending && (
          <div className="w-[90%] bg-white rounded-xl mb-4 text-[#ff0000] p-6">
            <h3 className="font-medium text-slate-600 pb-2 text-lg">Actions</h3>
