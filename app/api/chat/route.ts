...
export async function POST(req: Request) {
  ...
  console.log("req", req.headers.get("lang"));
  ...
  const urls = [
    ...
    "https://dfes.wa.gov.au/hazard-information/animal-welfare/animal-emergency-kit",
    "https://raw.githubusercontent.com/jowkar/emergency2/main/message_detail_397319835%5Bversion-latest%5D.html",
  ...
  const input = {
    query: `please respond to the following message in the following language ${req.headers.get(
      "lang"
